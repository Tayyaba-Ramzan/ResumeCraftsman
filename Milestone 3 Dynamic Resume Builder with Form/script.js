...
var generateResumeHTML = function (name, email, phone, age, education, skills, workExperience, profilePictureURL) {
    ...
    return "\n        <h2><b>Resume</b></h2>\n        ".concat(profilePictureURL ? "<img src=\"".concat(profilePictureURL, "\" alt=\"Profile Picture\" width=\"150\" height=\"150\"/>") : '', "\n        <h3><i class=\"fas fa-user\"></i> Personal Information</h3>\n        <p><b><i class=\"fas fa-user\"></i> Name:</b> ").concat(name, "</p>\n        <p><b><i class=\"fas fa-envelope\"></i> Email:</b> ").concat(email, "</p>\n        <p><b><i class=\"fas fa-phone\"></i> Phone:</b> ").concat(phone, "</p>\n        <p><b><i class=\"fas fa-calendar-alt\"></i> Age:</b> ").concat(age, "</p>\n        \n        <h3><i class=\"fas fa-graduation-cap\"></i> Education</h3>\n        ").concat(formatMultiLine(education), "\n        \n        <h3><i class=\"fas fa-cogs\"></i> Skills</h3>\n        ").concat(formatMultiLine(skills), "\n        \n        <h3><i class=\"fas fa-briefcase\"></i> Work Experience</h3>\n        ").concat(formatMultiLine(workExperience), "\n    ");
};
