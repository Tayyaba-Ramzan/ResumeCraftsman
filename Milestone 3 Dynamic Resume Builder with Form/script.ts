...
const generateResumeHTML = (
    ...
    return `
        ...
        <p><b><i class="fas fa-user"></i> Name:</b> ${name}</p>
        <p><b><i class="fas fa-envelope"></i> Email:</b> ${email}</p>
        <p><b><i class="fas fa-phone"></i> Phone:</b> ${phone}</p>
        <p><b><i class="fas fa-calendar-alt"></i> Age:</b> ${age}</p>
        
        <h3><i class="fas fa-graduation-cap"></i> Education</h3>
        ${formatMultiLine(education)}
        
        <h3><i class="fas fa-cogs"></i> Skills</h3>
        ${formatMultiLine(skills)}
        
        <h3><i class="fas fa-briefcase"></i> Work Experience</h3>
        ${formatMultiLine(workExperience)}
    `;
};
